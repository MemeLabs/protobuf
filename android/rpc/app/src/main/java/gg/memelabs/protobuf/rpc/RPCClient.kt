...
open class RPCClient(bridge: AndroidBridge) {
    companion object {
    ...
    suspend inline fun <T : Message<T, *>, reified R : Message<R, *>> callUnary(
        method: String,
        arg: T
