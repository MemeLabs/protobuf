...
import memelabs.protobuf.apis.rpc.*
...
open class RPCClient(s: ByteStream) {
    companion object {
    ...
    private var s: ByteStream = s

    init {
        this.s.onData = { b: ByteArray? -> this.handleCallback(b) }
    }
    ...
    fun <T : Message<T, *>> call(method: String, arg: T, callID: Long, parentID: Long = 0) {
        ...
        this.s.write(stream.toByteArray())
    }
